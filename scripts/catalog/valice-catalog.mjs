...

  {
    ...
    formats: [
      ...
      },
      {
        ...
        kdp: "not_created",
        priceBasis:
          "price-engine.mjs 2026-09-08 at the rebuilt 142 pp, 6\u00d79 B&W on white: prints at $2.70, KDP minimum list $4.51, recommended $10.99; $14.99 nets $6.29 (42.0%) at 60% royalty. The four extra pages of apparatus cost four cents a copy.",
      },
      {
        format: "hardcover",
        availability: "coming_soon",
    ...
    blockers: [
      ...
      "NO KDP LISTING YET. Paperback and hardcover are built \u2014 interior, companion leaf and "
        ...
        + "ASIN is invented.",
      "The apparatus is 24.6% of the volume against a 20% floor, measured from the content "
