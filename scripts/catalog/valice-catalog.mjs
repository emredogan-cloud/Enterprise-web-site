...

  {
    ...
    formats: [
      ...
      },
      {
        ...
        masterFileKey: null,
        priceBasis:
          "price-engine.mjs 2026-09-05, 76 pp 6\u00d79 B&W: prints at $2.30 on the flat rate for 110 pages or under, KDP minimum list $3.84, recommended $9.99. $12.99 nets $5.49 (42.3%). The Classics band of $16.99\u201319.99 assumes a 150-page-plus volume and this is 78, so $12.99 is proposed instead. The Founder decides at Gate 8.",
      },
    ],
    blockers: [
      ...
      "This is a short volume \u2014 76 pages against 154\u2013176 for the other Classics titles \u2014 because sections I to VI are where the Egyptian argument ends and section VII changes subject to the Greek hiera gramme. Both prices are set for the length rather than for the series.",
      "No Kindle edition planned at launch: KDP caps public-domain content at the 35% royalty tier, and the Kindle store already carries free scans of this title. No hardcover: 76 pages is at the very bottom of KDP's 75\u2013550 hardcover range and would bind badly. No large print: the move tables do not enlarge usefully. Each decision is recorded rather than assumed.",
    ],
  },
  {
