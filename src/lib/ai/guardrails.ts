...
export function buildSystemPrompt(page: {
  ...
  lines.push(
    ...
    "NOT mean the book is unavailable: some of those titles are free to request during the promotion,",
    "and freeDuringCampaign tells you which. Never infer availability from the price — read the book's",
