    ...
    >
      ...
      >
        <CoverArt
          ...
          title={book.title}
          sizes="64px"
          titleClassName="font-serif text-[12px] sm:text-[9px] font-medium leading-tight text-white line-clamp-3"
        />
      </Link>
      ...
      <div className="min-w-0 flex-1">
        ...
        {owned && (
          <Link
            ...
            className="mt-2 inline-flex w-fit items-center gap-1 rounded-full border border-[#f4c44b]/30 bg-[#f4c44b]/10 px-2.5 py-0.5 text-[12px] sm:text-[11px] font-medium text-[#f4c44b] transition-colors hover:border-[#f4c44b]/50"
          >
