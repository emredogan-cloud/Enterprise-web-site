        ...
        return (
          <button
            ...
            className={`group inline-flex items-center gap-2.5 rounded-full border px-4 py-2 text-sm transition-all ${
              isActive
                ? "border-emerald-bright/40 bg-emerald-bright/10 text-emerald-bright shadow-[0_0_18px_rgba(51,240,170,0.25)]"
                : "border-white/[0.08] bg-white/[0.03] text-fg-mid hover:-translate-y-0.5 hover:border-white/[0.16] hover:bg-white/[0.05] hover:text-fg-hi hover:shadow-[0_8px_24px_-8px_rgba(0,0,0,0.6)]"
            }`}
          >
            <Icon
              aria-hidden
              className={`h-3.5 w-3.5 transition-colors ${
                isActive ? "text-emerald-bright" : "text-fg-soft group-hover:text-emerald-bright"
              }`}
            />
