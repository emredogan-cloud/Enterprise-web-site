      ...
      <article className="home-glass home-card-hover relative overflow-hidden rounded-[24px] p-5 sm:p-6">
        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:gap-6">
          ...
          <div className="min-w-0 sm:w-[190px] sm:flex-shrink-0">
            <p className="text-[12px] sm:text-[10px] font-semibold uppercase tracking-[0.24em] text-fg-soft">
              Order
            </p>
          ...
          <div className="flex flex-col gap-3 sm:w-[230px] sm:flex-shrink-0 sm:items-end">
            <span
              className={`inline-flex items-center gap-1.5 rounded-full border ${status.border} ${status.bg} px-3 py-1 text-[12px] sm:text-[10px] font-semibold uppercase tracking-[0.14em] ${status.text}`}
            >
