...
|---|---|---|---|
| Gaming with Science podcast (Brian & Jason Wallace, University of Georgia) — did S3E06 on the Royal Game of Ur with Dr Walter Crist | Exact topical match; science-of-games audience | GamingWithSciencePodcast@gmail.com (from their site) | **SENT 2026-09-08 15:33 UTC** (id `1a081a7ab7a1cf33`) — offers review copy + the free boards pack as listener resource, no ask for a review. **REPLIED 2026-09-09 14:29 UTC** by Brian Kvitko (`bkvitko@gmail.com`, msg `1a08693f41246765`): wants the book, "pdf would be perfect", will point listeners to Valice on their Discord and share the printable-boards link, and offered GwS swag for a mailing address. **Our reply is PREPARED as a Gmail draft and NOT SENT** (draft `r2529886918775238308`, in-thread, recipients verified, no placeholder): this environment cannot attach a file, so the PDF must be attached by hand before sending. Status: **REPLY PREPARED — NOT YET SENT**. No promotion, episode, review or completed Discord share is claimed. |
...
| Oware Society (oware.org) — "Oware News" quarterly | Oware community; book prints the Ashanti rules with their source | Certificate expired on their site | Not drafted — retry |
| Dr Walter Crist (Leiden; ancient games archaeologist) | Expert reader; possible endorsement or correction | @waltros.bsky.social | Not contacted — consider after the book has a proof-read by him? Founder call |

## What a "yes" looks like, and what it is worth
- A podcast mention or a newsletter item → measured by Amazon Attribution. The first tag exists
  (campaign 585752812173052673, ad group `valicepress-com-world-games-pb`, for the site itself);
  give each partner their own ad group/tag in the same campaign and by companion
  downloads in the 7 days after.
- A homeschool-blog feature → companion downloads + `world-games-companion` signups.
- No partner is paid. No review is incentivised. A free copy is the entire offer.
