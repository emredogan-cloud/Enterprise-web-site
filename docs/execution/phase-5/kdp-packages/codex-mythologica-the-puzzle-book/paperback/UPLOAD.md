...
- PASS · **printed-url** — valicepress.com/companion/codex-puzzles
- PASS · **canonical-host** — no forbidden host on the page
- PASS · **eyebrow** — CONTINUE WITH VÂLIÇE PRESS
- PASS · **fonts-embedded** — 9 faces: AAAAAA+Lato-Light, AAAAAA+NotoSerif-Regular, AAAAAA+Lato-Regular, AAAAAA+Lato-Bold, AAAAAA+NotoSerif-Italic, AAAAAA+Lato-Black, AAAAAA+DejaVuSansMono, AAAAAA+DejaVuSansMono-Bold, AAAAAA+NotoSerif-Bold
- PASS · **pdf-metadata** — title="Codex Mythologica: The Puzzle Book: 100 Myth Puzzles from 19 Civilizations" author="Emre Doğan"

Regenerate with `node scripts/factory/build-companion-pages.mjs --commit --slug codex-mythologica-the-puzzle-book`.
