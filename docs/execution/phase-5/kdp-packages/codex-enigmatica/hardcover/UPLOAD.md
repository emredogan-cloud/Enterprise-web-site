...
**Generated:** 2026-09-03 · **ASIN:** B0HH3B4HQ7 · **KDP state:** live
...
- **Pages:** 276 → **276**
- **Spine:** 0.6900 in → **0.6900 in** (cream paper, 6×9 in)
- **Wrap width:** 12.9400 in → **12.9400 in**
...
```
/home/emre/Downloads/MY-DİGİTAL-BOOK/CODEX-ENIGMATICA/08_OUTPUT/HARDCOVER/interior.pdf
sha256 3f56c0c2be05e9638173358018afd6a862fb97543438b45f00829bc5073cf69d
67,722,613 bytes · 276 pages
```

The build it replaces is kept at `/home/emre/Downloads/MY-DİGİTAL-BOOK/CODEX-ENIGMATICA/08_OUTPUT/HARDCOVER/interior.pre-companion.pdf` and is never deleted.
